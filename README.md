...
```
This project has been replaced by https://github.com/ZaguanLabs/zchat.zsh for general chat
and https://github.com/ZaguanLabs/zcoder.zsh for coding/sysadmin.
```
